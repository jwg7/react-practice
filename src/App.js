...
const MovieInfo = (props) => {
  ...
  return (
    <div>
      ...
      <img className="imageSize" src={props.movie.Images[0]} />
    </div>
  );
};
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <MovieInfo movie={sampleMovies[1]}/>
        <MovieInfo movie={sampleMovies[2]}/> */}
<h1>Movie Titles Using React</h1>
        {sampleMovies.map((sampleMovie, index) => {
          return (<MovieInfo key={index} movie={sampleMovie}/>);
